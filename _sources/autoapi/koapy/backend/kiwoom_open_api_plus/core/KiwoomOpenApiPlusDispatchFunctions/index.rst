...
.. py:module:: koapy.backend.kiwoom_open_api_plus.core.KiwoomOpenApiPlusDispatchFunctions
...
.. autoapisummary::
   ...
   koapy.backend.kiwoom_open_api_plus.core.KiwoomOpenApiPlusDispatchFunctions.KiwoomOpenApiPlusDispatchFunctions




.. py:class:: KiwoomOpenApiPlusDispatchFunctions

   .. py:method:: CommConnect(self) -> int
      ...
      :returns: 에러코드, 성공하면 0 을, 실패하면 음수를 반환
      :rtype: int


   .. py:method:: CommTerminate(self) -> None
   ...
   .. py:method:: CommRqData(self, sRQName: str, sTrCode: str, nPrevNext: int, sScreenNo: str) -> int
      ...
      :param sRQName: 사용자 구분명 (임의로 지정, 한글 지원)
      :type sRQName: str
      :param sTrCode: 조회하려는 TR 코드
      :type sTrCode: str
      :param nPrevNext: 연속조회 여부 (0:조회, 2:연속)
      :type nPrevNext: int
      :param sScreenNo: 화면번호 (4자리 숫자 임의로 지정)
      :type sScreenNo: str
   ...
   .. py:method:: GetLoginInfo(self, sTag: str) -> str
      ...
      :param sTag: 사용자 정보 구분 태그 값
      :type sTag: str

      :returns: 태그값에 따른 데이터 반환
      :rtype: str


   .. py:method:: SendOrder(self, sRQName: str, sScreenNo: str, sAccNo: str, nOrderType: int, sCode: str, nQty: int, nPrice: int, sHogaGb: str, sOrgOrderNo: str) -> int
      ...
      :param sRQName: 사용자 구분 요청명
      :type sRQName: str
      :param sScreenNo: 화면번호 (4자리)
      :type sScreenNo: str
      ...
      :type sHogaGb: str
      :param sOrgOrderNo: 원주문번호, 신규주문에는 공백 입력, 정정/취소시 입력합니다.
      :type sOrgOrderNo: str

      :returns: 에러코드, 성공하면 0 을, 실패하면 음수를 반환
      :rtype: int


   .. py:method:: SendOrderFO(self, sRQName: str, sScreenNo: str, sAccNo: str, sCode: str, lOrdKind: int, sSlbyTp: str, sOrdTp: str, lQty: int, sPrice: str, sOrgOrdNo: str) -> int
      ...
      :param sCode: 종목코드
      :type sCode: str
      :param lOrdKind: 주문종류 (1:신규매매, 2:정정, 3:취소)
      :type lOrdKind: int
      :param sSlbyTp: 매매구분 (1:매도, 2:매수)
      :type sSlbyTp: str
      :param sOrdTp: 거래구분
      :type sOrdTp: str
      :param lQty: 주문수량
   ...
   .. py:method:: SetInputValue(self, sID: str, sValue: str) -> None
      ...
      :param sID: TR에 명시된 Input 이름
      :type sID: str
      :param sValue: Input 이름으로 지정한 값
      :type sValue: str


   .. py:method:: SetOutputFID(self, sID: str) -> int

      1.0.0.1 버전 이후 사용하지 않음.


   .. py:method:: CommGetData(self, sJongmokCode: str, sRealType: str, sFieldName: str, nIndex: int, sInnerFieldName: str) -> str
   ...
   .. py:method:: DisconnectRealData(self, sScnNo: str) -> None
      ...
      :param sScnNo: 화면번호 (4자리)


   .. py:method:: GetRepeatCnt(self, sTrCode: str, sRecordName: str) -> int
   ...
   .. py:method:: CommKwRqData(self, sArrCode: str, bNext: int, nCodeCount: int, nTypeFlag: int, sRQName: str, sScreenNo: str) -> int
      ...
      :type sArrCode: str
      :param bNext: 연속조회 여부 (0:기본값, 1:연속조회(지원안함))
      :type bNext: int
      :param nCodeCount: 종목개수
      :type nCodeCount: int
      :param nTypeFlag: 조회구분 (0:주식 종목, 3:선물옵션 종목)
      :type nTypeFlag: int
      :param sRQName: 사용자 구분명
      :type sRQName: str
      :param sScreenNo: 화면번호 (4자리)
   ...
   .. py:method:: GetAPIModulePath(self) -> str

      OpenAPI 모듈의 경로를 반환한다.

      :returns: OpenAPI 모듈의 설치 경로
      :rtype: str


   .. py:method:: GetCodeListByMarket(self, sMarket: str) -> str
      ...
      :param sMarket: 시장 구분값
      :type sMarket: str

      :returns: 종목코드 리스트, 종목간 구분은 ';' 이다.
      :rtype: str


   .. py:method:: GetConnectState(self) -> int

      현재 접속상태를 반환한다.

      서버와 현재 접속 상태를 알려줍니다.

      :returns: 접속상태, 1:연결, 0:연결안됨
      :rtype: int


   .. py:method:: GetMasterCodeName(self, sTrCode: str) -> str
   ...
   .. py:method:: GetMasterListedStockCnt(self, sTrCode: str) -> int
   ...
   .. py:method:: GetMasterConstruction(self, sTrCode: str) -> str
      ...
      :returns: 감리구분 (정상, 투자주의, 투자경고, 투자위험, 투자주의환기종목)
      :rtype: str


   .. py:method:: GetMasterListedStockDate(self, sTrCode: str) -> str
      ...
      :returns: 상장일 (8자리, YYYYMMDD)
      :rtype: str


   .. py:method:: GetMasterLastPrice(self, sTrCode: str) -> str
   ...
   .. py:method:: GetMasterStockState(self, sTrCode: str) -> str
      ...
      :returns: 종목상태 (정상, 증거금N%, 거래정지, 관리종목, 감리종목, 투자유의종목, 담보대출, 액면분할, 신용가능)
      :rtype: str


   .. py:method:: GetDataCount(self, strRecordName: str) -> int
      ...
      :param strRecordName: 레코드 명
      :type strRecordName: str

      :returns: 레코드 반복개수
      :rtype: str


   .. py:method:: GetOutputValue(self, strRecordName: str, nRepeatIdx: int, nItemIdx: int) -> str
   ...
   .. py:method:: GetCommData(self, strTrCode: str, strRecordName: str, nIndex: int, strItemName: str) -> str
      ...
      :param strTrCode: TR코드
      :type strTrCode: str
      :param strRecordName: 레코드명
      :type strRecordName: str
      :param nIndex: 복수데이터 인덱스
      :type nIndex: int
      :param strItemName: 아이템명 (TR별 출력항목 이름)
      :type strItemName: str

      :returns: 수신 데이터
      :rtype: str


   .. py:method:: GetCommRealData(self, sTrCode: str, nFid: int) -> str
   ...
   .. py:method:: GetChejanData(self, nFid: int) -> str
   ...
   .. py:method:: GetThemeGroupList(self, nType: int) -> str
   ...
   .. py:method:: GetThemeGroupCode(self, strThemeCode: str) -> str
      ...
      :type strThemeCode: str

      :returns: 종목코드 리스트
      :rtype: str


   .. py:method:: GetFutureList(self) -> str
   ...
   .. py:method:: GetFutureCodeByIndex(self, nIndex: int) -> str
      ...
      :param nIndex: 0 ~ 3: 지수선물코드, 4 ~ 7: 지수스프레드
      :type nIndex: int
   ...
   .. py:method:: GetActPriceList(self) -> str
   ...
   .. py:method:: GetMonthList(self) -> str
      ...
      :returns: 월물 (YYYYMM;YYYYMM;...)
      :rtype: str


   .. py:method:: GetOptionCode(self, strActPrice: str, nCp: int, strMonth: str) -> str
      ...
      :param strActPrice: 행사가 (소수점 포함)
      :type strActPrice: str
      :param nCp: 콜/풋 구분 (2:콜, 3:풋)
      :type nCp: int
      :param strMonth: 월물 (6자리, YYYYMM)
      :type strMonth: str
   ...
   .. py:method:: GetOptionCodeByMonth(self, sTrCode: str, nCp: int, strMonth: str) -> str
   ...
   .. py:method:: GetOptionCodeByActPrice(self, sTrCode: str, nCp: int, nTick: int) -> str
   ...
   .. py:method:: GetSFutureList(self, strBaseAssetCode: str) -> str

      주식선물 코드 리스트를 반환한다.

      출력값의 코드간 구분은 ';' 이다.

      :param strBaseAssetCode: 기초자산코드
      :type strBaseAssetCode: str

      :returns: 종목코드 리스트
      :rtype: str


   .. py:method:: GetSFutureCodeByIndex(self, strBaseAssetCode: str, nIndex: int) -> str

      주식선물 코드를 반환한다.

      :param strBaseAssetCode: 기초자산코드
      :type strBaseAssetCode: str
      :param nIndex: 0 ~ 3: 지수선물코드, 4 ~ 7: 지수스프레드, 8 ~ 11: 스타 선물, 12 ~ : 스타 스프레드
      :type nIndex: int
   ...
   .. py:method:: GetSActPriceList(self, strBaseAssetGb: str) -> str

      주식옵션 행사가 리스트를 반환한다.

      :param strBaseAssetGb: 기초자산코드구분
      :type strBaseAssetGb: str

      :returns: 행사가 리스트, 행사가간 구분은 ';'
      :rtype: str
   ...
   .. py:method:: GetSMonthList(self, strBaseAssetGb: str) -> str
   ...
   .. py:method:: GetSOptionCode(self, strBaseAssetGb: str, strActPrice: str, nCp: int, strMonth: str) -> str
   ...
   .. py:method:: GetSOptionCodeByMonth(self, strBaseAssetGb: str, sTrCode: str, nCp: int, strMonth: str) -> str
   ...
   .. py:method:: GetSOptionCodeByActPrice(self, strBaseAssetGb: str, sTrCode: str, nCp: int, nTick: int) -> str
   ...
   .. py:method:: GetSFOBasisAssetList(self) -> str

      주식선옵 기초자산코드/종목명을 반환한다.

      :returns: 기초자산코드/종목명, 코드와 종목명 구분은 '|', 코드간 구분은 ';'
      :rtype: str


   .. py:method:: GetOptionATM(self) -> str
   ...
   .. py:method:: GetSOptionATM(self, strBaseAssetGb: str) -> str
   ...
   .. py:method:: GetBranchCodeName(self) -> str

      회원사 코드와 이름을 반환합니다.

      :returns: 회원사코드/회원사명, 코드와 이름 구분은 '|', 코드간 구분은 ';' (회원사코드|회원사명;회원사코드|회원사명;...)
      :rtype: str


   .. py:method:: CommInvestRqData(self, sMarketGb: str, sRQName: str, sScreenNo: str) -> int
      ...
      :param sMarketGb: 시장구분
      :type sMarketGb: str
      :param sRQName: 사용자 구분값
      :type sRQName: str
      :param sScreenNo: 화면번호 (4자리)
      :type sScreenNo: str
   ...
   .. py:method:: SendOrderCredit(self, sRQName: str, sScreenNo: str, sAccNo: str, nOrderType: int, sCode: str, nQty: int, nPrice: int, sHogaGb: str, sCreditGb: str, sLoanDate: str, sOrgOrderNo: str) -> int
      ...
      :param sHogaGb: 거래구분
      :type sHogaGb: str
      :param sCreditGb: 신용구분
      :type sCreditGb: str
      :param sLoanDate: 대출일 (8자리, YYYYMMDD)
      :type sLoanDate: str
   ...
   .. py:method:: KOA_Functions(self, sFunctionName: str, sParam: str) -> str
      ...
      :param sFunctionName: 함수이름 혹은 기능이름
      :type sFunctionName: str
      :param sParam: 함수 매개변수
      :type sParam: str
   ...
   .. py:method:: SetInfoData(self, sInfoData: str) -> int
   ...
   .. py:method:: SetRealReg(self, strScreenNo: str, strCodeList: str, strFidList: str, strOptType: str) -> int
      ...
      :param strScreenNo: 화면번호 (4자리)
      :type strScreenNo: str
      :param strCodeList: 종목코드 (복수종목가능, ';' 구분자)
      :type strCodeList: str
      :param strFidList: FID (';' 구분자)
      :type strFidList: str
      :param strOptType: 등록타입 (0:최초 등록시, 혹은 기존 등록된 종목 해지하고 등록 1:기존 등록된 종목 유지하고 등록)
      :type strOptType: str
   ...
   .. py:method:: GetConditionLoad(self) -> int
      ...
      :returns: 성공하면 1, 아니면 0을 반환
      :rtype: int


   .. py:method:: GetConditionNameList(self) -> str
   ...
   .. py:method:: SendCondition(self, strScrNo: str, strConditionName: str, nIndex: int, nSearch: int) -> int
      ...
      :type nIndex: int
      :param nSearch: 조회구분 (0:일반조회, 1:실시간조회 (최초 일반조회 + 이후 실시간조회), 2:연속조회)
      :type nSearch: int
   ...
   .. py:method:: SendConditionStop(self, strScrNo: str, strConditionName: str, nIndex: int) -> None
   ...
   .. py:method:: GetCommDataEx(self, strTrCode: str, strRecordName: str)
   ...
   .. py:method:: SetRealRemove(self, strScrNo: str, strDelCode: str) -> None
      ...
      :param strScrNo: 화면번호 (4자리) 또는 "ALL"
      :type strScrNo: str
   ...
   .. py:method:: GetMarketType(self, sTrCode: str) -> int
