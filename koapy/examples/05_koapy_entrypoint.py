...
#   1. Run 4_koapy_tray_application.py script in 32bit environment
#       => Server will start with tray application
#   2. Open another console and run 5_koapy_entrypoint.py script (this one), in 32bit or 64bit environment
#       => Client will connect to the existing server
#
# 2. Server-In-Subprocess scenario
#   1. Just run 5_koapy_entrypoint.py script (this one) in 32bit environment
