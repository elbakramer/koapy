...
from koapy.grpc.utils.QueueIterator import BufferedQueueIterator

class QueueBasedBufferedIterator(BufferedQueueIterator):
    ...
    def _consume_iterator(self):
        try:
            ...
            logging.exception('Exception raised while consuming iterator')
