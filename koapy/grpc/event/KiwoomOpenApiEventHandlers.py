...
class KiwoomOpenApiAllEventHandler(KiwoomOpenApiEagerAllEventHandler):
...
class KiwoomOpenApiSomeEventHandler(KiwoomOpenApiEagerSomeEventHandler):
...
class KiwoomOpenApiSomeBidirectionalEventHandler(KiwoomOpenApiLazySomeEventHandler):
    ...
    def await_handled(self):
        ...
        if request.HasField('handled_request'):
            ...
            raise KiwoomOpenApiError('Unexpected request')
...
class KiwoomOpenApiKwTrEventHandler(KiwoomOpenApiEventHandlerForGrpc):
    ...
    def __init__(self, control, request, context, screen_manager):
        ...
        self._code_lists = [codes for codes in chunk(self._code_list, self._num_codes_per_request)]
...
class KiwoomOpenApiBaseOrderEventHandler(KiwoomOpenApiEventHandlerForGrpc):
    ...
    def OnReceiveTrData(self, scrnno, rqname, trcode, recordname, prevnext, datalength, errorcode, message, splmmsg):
        ...
        if order_no:
            response = self.ResponseForOnReceiveTrData(scrnno, rqname, trcode, recordname, prevnext, datalength, errorcode, message, splmmsg)
            self.observer.on_next(response)
...
class KiwoomOpenApiAllOrderEventHandler(KiwoomOpenApiBaseOrderEventHandler):

    pass

class KiwoomOpenApiOrderEventHandler(KiwoomOpenApiBaseOrderEventHandler):
