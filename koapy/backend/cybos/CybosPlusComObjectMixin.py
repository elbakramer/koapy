...
class CybosPlusComObjectMixin:

    def GetConnectState(self):
        return self.CpUtil.CpCybos.IsConnect

    def CommConnect(self, id=None, password=None, cert=None, auto_account_password=None, auto_cert_password=None, price_check_only=None):
        """
        ...
        login_config = {
            ...
            'password': password,
            'cert': cert,
            'auto_account_password': auto_account_password,
            'auto_cert_password': auto_cert_password,
