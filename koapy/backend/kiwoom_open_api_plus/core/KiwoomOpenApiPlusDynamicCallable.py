...
from koapy.backend.kiwoom_open_api_plus.core.KiwoomOpenApiPlusSignature import KiwoomOpenApiPlusDispatchSignature
...
class KiwoomOpenApiPlusDynamicCallable:
    ...
    def __call__(self, *args, **kwargs):
        ...
        if not self.is_valid_return_type(result):
            raise TypeError('Return type of %s was expected for function call %s(...), but %s was found.' % (
